...
export class PatientVisitDetailsService {
 ...
 let token=this.authService.getToken();
  ...
  getstatusfornotification(phyid:string):Observable<AppointmentEditHistory[]>{
    console.log("lp"+phyid)
    console.log("notification page")
    return this.http.get<AppointmentEditHistory[]>("http://localhost:8084/api/private/appt/providernotifications/"+phyid+"/decline"+"/reschedule");
  }
