...
@Component({
  selector: 'app-edit-patient-emergency-details',
  templateUrl: './edit-patient-emergency-details.component.html',
  styleUrls: ['./edit-patient-emergency-details.component.css']
})
export class EditPatientEmergencyDetailsComponent implements OnInit {

  constructor(private _snack:MatSnackBar, private dashboardService: DashboardService,private addressService:AdressService,private postalcodeService: PostalcodeService,private patientService: PatientMasterService,private formBuilder:FormBuilder,private emergencyDetailsService:EmergencyDetailsService) { }
...
// reason?:string
  ...
  ngOnInit(): void {
    ...
    this.address=JSON.parse(sessionStorage.getItem('User') || '{}').address[1];
    this.patientEmergencyDetails=JSON.parse(sessionStorage.getItem('User') || '{}').patientEmergencyDetails;
    this.patientEmergencyDetails.patientRegistrationDetails = this.user;
